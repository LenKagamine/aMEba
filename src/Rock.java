...
public class Rock extends MapObject{
	...
	public Rock(Map map,double x,double y){
		super(map,x,y);
		try{ // create image and set dimensions
	...
	public void draw(Graphics2D g){ // draw onto map if within bounds of field of view
		mapx = map.getX();
		mapy = map.getY();
	...
	public boolean checkStuck(double x, double y){ // check if something is stuck in the rock
